-- Convert schema '/home/jjohnston/sites/Xqursion/share/migrations/_source/deploy/25/001-auto.yml' to '/home/jjohnston/sites/Xqursion/share/migrations/_source/deploy/24/001-auto.yml':;

;
BEGIN;

;
DROP INDEX journey_log_fk_step_id;

;
DROP INDEX journey_log_idx_step_id;
